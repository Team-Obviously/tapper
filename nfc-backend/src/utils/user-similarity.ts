...
const userA: UserProfile = {
    interests: ['Football', 'Running', 'Coding'],
    skillLevel: 'Expert',
    ...
    experience: '10+ years',
    isHiring: 'true',
    resumeUrl: 'acme.com/resume',
    data: {}
};

const userB: UserProfile = {
    interests: ['Football', 'Running', 'Hiking'], // Jaccard: 2 intersection / 4 union = 0.5
    skillLevel: 'Expert', // Match
    availability: 'Weekends', // Match
    company: 'Acme Corp', // Match
    position: 'Engineer', // No match
    experience: '10+ years', // Match
    isHiring: 'false', // No match
    resumeUrl: 'acme.com/cv', // No match
    data: {}
};

const userC: UserProfile = {
    interests: ['Chess', 'Billiards'], // Jaccard: 0/5 = 0.0
    skillLevel: 'Beginner', // No match
    availability: 'Weekdays', // No match
    company: 'Zeta Inc', // No match
    position: 'Manager', // Match (by chance)
    experience: '1 year', // No match
    isHiring: 'true', // Match
    resumeUrl: null, // No match
    data: null
};

// Calculate and log similarities
const similarityA_B = calculateUserSimilarity(userA, userB);
const similarityA_C = calculateUserSimilarity(userA, userC);

console.log(`\n--- Similarity Scores ---`);
console.log(`User A vs User B: ${similarityA_B.toFixed(4)}`);
/*
Breakdown for A vs B:
Interests: 0.5 * 0.40 = 0.2000
Skill: 1.0 * 0.20 = 0.2000
Avail: 1.0 * 0.15 = 0.1500
Company: 1.0 * 0.05 = 0.0500
Position: 0.0 * 0.05 = 0.0000
Experience: 1.0 * 0.05 = 0.0500
IsHiring: 0.0 * 0.05 = 0.0000
ResumeUrl: 0.0 * 0.00 = 0.0000
Data: 1.0 * 0.05 = 0.0500 (Both are empty)
TOTAL: 0.7000
*/

console.log(`User A vs User C: ${similarityA_C.toFixed(4)}`);
/*
Breakdown for A vs C:
Interests: 0.0 * 0.40 = 0.0000
Skill: 0.0 * 0.20 = 0.0000
Avail: 0.0 * 0.15 = 0.0000
Company: 0.0 * 0.05 = 0.0000
Position: 1.0 * 0.05 = 0.0500
Experience: 0.0 * 0.05 = 0.0000
IsHiring: 1.0 * 0.05 = 0.0500
ResumeUrl: 0.0 * 0.00 = 0.0000
Data: 0.0 * 0.05 = 0.0000
TOTAL: 0.1000
*/

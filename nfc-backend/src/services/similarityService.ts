...
import { calculateUserSimilarity, calculateUserSimilarityWithFields, UserProfile } from '../utils/user-similarity';
...
export class SimilarityService {
     ...
     */
    async calculateSimilarity(userId1: string, userId2: string): Promise<{
        similarity: number;
     ...
     */
    async getInterestBasedConnections(userId: string): Promise<{
        userId: string;
        similarity: Array<{
            interest: string;
        ...
        const interestGroups: Map<string, Array<{
            userId: string;
            firstName: string | null;
            lastName: string | null;
            email: string;

 ...
 */
export async function createAnonymousProfile(req: Request, res: Response) {
    try {
 ...
 */
export async function generateSimilarityProof(req: Request, res: Response) {
    try {
        ...
        const proofResult = await zkSimilarityService.generateSimilarityProof(
            commitmentId1,
            commitmentId2,
            similarityThreshold
        );
 ...
 */
export async function verifyZkProof(req: Request, res: Response) {
    try {
 ...
 */
export async function getAnonymousMatches(req: Request, res: Response) {
    try {
        ...
        const matches = await zkSimilarityService.findAnonymousMatches(
            commitmentId,
            minSimilarity
        );
 ...
 */
export async function initiateIdentityReveal(req: Request, res: Response) {
    try {
 ...
 */
export async function zkSimilarityHealth(req: Request, res: Response) {
    try {

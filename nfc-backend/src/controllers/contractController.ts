 ...
 */
export async function createOnChainCommitment(req: Request, res: Response) {
    try {
 ...
 */
export async function submitSimilarityProof(req: Request, res: Response) {
    try {
 ...
 */
export async function getCommitmentDetails(req: Request, res: Response) {
    try {
 ...
 */
export async function getSimilarityProofDetails(req: Request, res: Response) {
    try {
 ...
 */
export async function getUserReputationOnChain(req: Request, res: Response) {
    try {
 ...
 */
export async function contractHealth(req: Request, res: Response) {
    try {
        const contractInfo = await zkSimilarityService.getContractInfo();

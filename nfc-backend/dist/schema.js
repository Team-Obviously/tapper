...
export const users = pgTable('users', {
    ...
    telegramId: text('telegram_id'), // Telegram user ID for messaging
    // Sports Information
...
export const userNfcs = pgTable('user_nfcs', {
    id: uuid('id').defaultRandom().primaryKey(),
...
export const acceptedConnections = pgTable('accepted_connections', {
    id: uuid('id').defaultRandom().primaryKey(),

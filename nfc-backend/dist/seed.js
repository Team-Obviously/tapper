...
const generateConnections = (userIds, nfcIds) => {
...
const generateInvitations = (userIds) => {
...
const generateAcceptedConnections = (userIds, invitationIds) => {
    const acceptedList = [];

 ...
 */
export async function getSimilarity(req, res) {
    try {
...
export async function getSimilarUsers(req, res) {
    try {
        ...
        // Get similar users
        const similarUsers = await similarityService.getSimilarUsers(userId, minSimilarity, limit);
        return res.status(200).json({
            success: true,
            data: {
                targetUserId: userId,
 ...
 * Path params: userId
 */
export async function getInterestConnections(req, res) {
    try {
        const { userId } = req.params;
        if (!userId) {
            return res.status(400).json({
 ...
 */
export async function similarityHealth(req, res) {
    try {

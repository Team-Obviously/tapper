...
async function updatePendingConnections(nfcId, userId) {
    try {
...
export async function registerNfc(req, res) {
...
// Get user's NFCs
export async function getUserNfcs(req, res) {
...
export async function connectNfc(req, res) {
...
// Toggle NFC status
export async function toggleNfcStatus(req, res) {
